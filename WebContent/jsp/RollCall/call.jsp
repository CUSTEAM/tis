...
<div class="bs-callout bs-callout-warning">
	...
	${info.date} 星期${info.week},${info.ClassName} - ${info.chi_name}出席記錄
	...
	<div class="col-xs-12 col-md-6">
		...
		<table class="table table-condensed table-bordered table-hover table-striped">
			...
			<tr>
				...
				<select onChange="editDilg('${s.student_no}', ${d.cls}, this.value);" class="form-control" style="width:auto;">
					...
					<c:if test="${d.abs eq '0'}"><option selected value="0">生理</option></c:if>
				</select>
				</c:if> 
