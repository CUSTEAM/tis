 ...
 *
 */
public class PrintStds extends BasePrintXmlAction{
	...
	public void print(HttpServletResponse response, List<Map>list, List<Map>elist, String info) throws IOException{
		...
		out.println (" </Styles>");				
			...
			for(int i=0; i<list.size(); i++){
				...
				out.println ("    <Cell><Data ss:Type='String'>"+list.get(i).get("Email")+"</Data></Cell>");
				out.println ("   </Row>");
			}
			...
			out.println ("     x:Data='&amp;L&amp;12人數:"+list.size()+" &amp;C&amp;20 "+info+"學生名單&amp;'/>");
